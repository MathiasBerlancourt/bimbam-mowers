...
// console.log(instructionsRun(data));
const createGrid = (rows, columns, mowerX, mowerY) => {
  const grid = [];
...
console.log(createGrid(5, 5, 2, 4));
